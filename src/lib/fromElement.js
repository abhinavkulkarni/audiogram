export default function fromElement(element_id, canvas_id, options) {
    ...
    function run() {
        ...
        element.onpause = async (e) => await Promise.all([audioCtx.suspend()])
        element.onplay = async (e) => await Promise.all([audioCtx.resume()])
        ...
        function renderFrame() {
            ...
            this.visualize(data, canvas_id, options, frameCount);
        }
